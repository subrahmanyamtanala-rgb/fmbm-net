...
\author{Subrahmanyam~Tanala,~\IEEEmembership{Member,~IEEE,}
        and~Surender~Reddy~Salkuti,~\IEEEmembership{Senior~Member,~IEEE}%
...
\thanks{S.~R.~Salkuti is with the Department of Railroad and Electrical
Engineering, Woosong University, Daejeon 34606, South Korea
(e-mail: surender@wsu.ac.kr).}%
\thanks{Manuscript received May 2026. Supported in part by ANITS Seed
Research Grant No.~ANITS/SRG/2025-26/EEE-04 and Woosong University Faculty
Research Fund No.~WSU/FRF/2026-007. Code, pre-processed splits, and
training scripts are available at
\texttt{https://github.com/tanala-anits/fmbm-net} (anonymous review link:
\texttt{https://anonymous.4open.science/r/fmbm-net-review}).}}

\markboth{IEEE TRANSACTIONS ON BIOMEDICAL ENGINEERING,~VOL.~73,~NO.~6,~JUNE~2026}%
{Tanala \MakeLowercase{\textit{et al.}}: FMBM-Net for Privacy-Preserving Biomedical AI}
...
non-private training at $\varepsilon\!=\!2.0$ is atypically small for a
federated DP model. We identify three contributing factors: (i)~the FLCAT
distributes DP noise across three correlated latent spaces, reducing
effective sensitivity; (ii)~Dirichlet($\alpha\!=\!0.5$) represents moderate
rather than extreme heterogeneity; and (iii)~the TCGA-LUNG task is a
well-balanced binary classification. Researchers should expect larger gaps
on tasks with stronger heterogeneity or stricter privacy budgets.
